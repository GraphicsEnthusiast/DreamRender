...
int main(int argc, char** argv) {
	...
	else if (scene_parser.inte_info.type == "volumetric_path_tracing") {
		inte = make_shared<VolumetricPathTracing>(make_shared<Scene>(scene), scene_parser.inte_info.depth,
			scene_parser.inte_info.sampler_type, scene_parser.inte_info.light_strategy);
	}
	else {
